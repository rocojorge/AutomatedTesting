...
class IFX_SCONF:
    try:
        ...
        IFX_SCONF_DEVICE_PORT = int(os.environ['IFX_SCONF_DEVICE_PORT'])
    except:
    ...
    def __init__(self) -> None: 
        ...
        self.IFX_SCONF_DEVICE_PORT = IFX_SCONF.IFX_SCONF_DEVICE_PORT
    ...
    def get_Device_Port(self):
        return int(self.IFX_SCONF_DEVICE_PORT)